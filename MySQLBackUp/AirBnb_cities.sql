...
CREATE TABLE `cities` (
  ...
  CONSTRAINT `cities_ibfk_2` FOREIGN KEY (`countryID`) REFERENCES `countries` (`countryID`)
...
INSERT INTO `cities` VALUES (1,'Malibu',1),(2,'Pitai',2),(3,'Rio Claro',3),(4,'Junín',4),(5,'Shuangqiao',5),(6,'Qukuhu',6),(7,'Kabac',7),(8,'Gabrovo',8),(9,'Seiça',9),(10,'Tuanjie',10);
